...
export default function AdminCreateEvent() {
    ...
    useEffect(() => {
        ...
        async function loadEvent() {
            try {
                const response = await fetch(`https://api-zavlosoft.shop/api/events/edit/${id}`);
                ...
                form.reset({
                    ...
                    priceInteira: String(event.price),
                });
    ...
    const onSubmit = async (data: EventFormData) => {
        ...
        try {
            const response = await fetch(
                `https://api-zavlosoft.shop/api/events/edit/${id}`,
                {
                    method: "PUT",
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        price: Number(data.priceInteira),
                        image: imagePreview,
                    }),
                }
            );
    ...
    return (
        <AdminLayout title="Salvar Evento">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <Card className="border-border">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Preencha as informações do evento para salvá-lo na plataforma
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
